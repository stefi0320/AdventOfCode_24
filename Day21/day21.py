...
def day21():
    ...
    print(sum(int(code[:-1]) * find_shortest_sequence(code, proxies=2) for code in input_txt))
    print(sum(int(code[:-1]) * find_shortest_sequence(code, proxies=25) for code in input_txt))
